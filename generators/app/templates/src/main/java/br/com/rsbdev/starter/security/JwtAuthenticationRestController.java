...
import <%=packageName%>.controller.AbstractRestController;
import <%=packageName%>.security.exception.InvalidPasswordException;
import <%=packageName%>.security.exception.InvalidTokenException;
